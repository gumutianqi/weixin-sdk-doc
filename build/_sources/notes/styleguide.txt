...
Strive to keep any contributions relevant to the :ref:`链接到该文档的目录 <guide-catlog-ref>`.
...
<http://sphinx.pocoo.org/ext/todo.html?highlight=todo#directive-todo>`_.

To avoid cluttering the :ref:`todo-list-ref`, use a single ``todo`` for stub
